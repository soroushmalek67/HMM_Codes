...
%     set(gca,'XColor','w','YColor','w','YLim',[-.3 1.5],'XLim',[tx1 tx2])
    ...
    title(['epoch ' num2str(ep) '\_Th' num2str(ThPer)],'FontSize',16)
     xlabel('Time (ms)','fontsize', 14);
%     xlim([0 TrainEnd])
   saveas(gcf, ['Epochs' num2str(ep) 'Sleep' num2str(sleep) 'Th' num2str(ThPer) '.fig']);
...
filename = ['HMM_all_train_',num2str(States),'states_',num2str(Repetitions),'rep_run',num2str(Run_Num),'_sleep',num2str(sleep),'Th',num2str(ThPer),'.mat'];
